...
class UnitTests(unittest.TestCase):
    ...
    def test_extracted_data_from_apache_combined_format_file(self):
        result = extract_data_from_file("1", "/Users/danielhall/Desktop/Automation/Python Scripts/tests/access_log_analyzer_test/apache_access_combined.log")
        extracted_dict_list = [
            {
                "ip": "161.90.170.15",
    ...
    def test_extracted_data_from_apache_common_format_file(self):
        result = extract_data_from_file("2", "/Users/danielhall/Desktop/Automation/Python Scripts/tests/access_log_analyzer_test/apache_access_common.log")
        extracted_dict_list = [
            {
                "ip": "219.74.230.75",
                "timestamp": "29/Aug/2025:00:37:02",
    ...
    def test_extracted_data_from_loggly_json_format_file(self):
        result = extract_data_from_file("3", "/Users/danielhall/Desktop/Automation/Python Scripts/tests/access_log_analyzer_test/loggly_events.jsonl")
        extracted_dict_list = [
            {
    ...
    def test_extracted_data_from_nginx_file(self):
        result = extract_data_from_file("4", "/Users/danielhall/Desktop/Automation/Python Scripts/tests/access_log_analyzer_test/nginx_access.log")
        extracted_data_list = [
            {
                "ip": "127.167.171.1",
                "timestamp": "29/Aug/2025:00:37:02",
    ...
    def test_total_number_of_requests(self):
        ...
        result = total_number_of_requests(data_list)
    ...
    def test_hourly_traffics(self):
        data_list = [
            ...
            {
                "ip": "117.74.190.180",
                "timestamp": "29/Aug/2025:01:37:02",
                "method": "POST",
                "path": "/dashboard",
                "protocol": "HTTP/1.1",
                "status": 503,
